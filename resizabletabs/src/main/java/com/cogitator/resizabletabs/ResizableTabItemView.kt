 ...
 */
class ResizableTabItemView : LinearLayout {
    ...
    private val iconFromColor: Int = ContextCompat.getColor(context, R.color.rtl_icon_from_color)
    private val iconToColor: Int = ContextCompat.getColor(context, R.color.rtl_icon_to_color)
